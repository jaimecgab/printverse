...
export function QuotesPage() {
  ...
  const filtered = quotes.filter((quote) => (filter === 'ALL' || quote.status === filter) && [quote.quoteNumber, quote.title || '', quote.customer.name, quote.customer.phone].some((value) => value.toLocaleLowerCase('es-MX').includes(query)))
