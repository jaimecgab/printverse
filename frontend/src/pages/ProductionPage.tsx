...
export function ProductionPage() {
  ...
  const hasActiveFilters = status !== 'ALL' || priority !== 'ALL' || due !== 'ALL' || search !== ''
  const showClearFilters = orders.length > 0 && hasActiveFilters && filtered.length === 0
