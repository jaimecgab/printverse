...
public class MaterialController {
    ...
    @PostMapping
    public ResponseEntity<MaterialDtos.Response> create(@Valid @RequestBody MaterialDtos.Request request) {
        MaterialDtos.Response response = service.create(request);
